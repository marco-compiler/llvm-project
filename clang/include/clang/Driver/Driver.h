...
public:
  ...
  /// Whether the driver should invoke marco for Modelica inputs.
...
public:
  ...
  const char *getInstalledDir() const { return Dir.c_str(); }
  ...
  void BuildMarcoActions(Compilation &C, llvm::opt::DerivedArgList &Args,
